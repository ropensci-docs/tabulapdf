...
**tabulapdf** package. Some contributions can be rather easy to do
...
[reprex](https://reprex.tidyverse.org) for your posting to the
[**tabulapdf** issue
tracker](https://github.com/ropensci/tabulapdf/issues). Try not to
...
**tabulapdf** include the [RStudio
community](https://community.rstudio.com), on Twitter (a good search
term is `tabulapdf #rstats`), and on [Stack
...
users. Bugfix PRs also requre some explanation about the bug and how the
proposed fix will remove that bug. A great way to illustrate the bug is
to include a [reprex](https://reprex.tidyverse.org). While all this
...
- Look at the GitHub Actions build status badges before and after making
  changes; these badges are available in the package
  [README](https://github.com/ropensci/tabulapdf).  
- The **tabulapdf** package follows the tidyverse [style
